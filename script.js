function generarSucesion() {
    ...
    // Detectar cualquier letra como variable y reemplazarla por 'k'
    ...
    for (let k = m; k <= n; k++) {
      ...
      detalles += `Término a(${k}) = ${ak.toFixed(4)}<br>`;
      suma += ak;
      multiplicacion *= ak;
    }
  ...
  function evaluarFormula(f, k) {
    try {
      ...
      // Convertir multiplicaciones implícitas como 2k o (k+1)2 en 2*k o (k+1)*2
